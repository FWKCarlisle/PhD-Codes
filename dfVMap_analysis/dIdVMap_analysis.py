...
#%% 2D plot 
x = np.load(r'C:\Users\physicsuser\Downloads\dfV\find_circles\xGrid_18_04.npy')
y = np.load(r'C:\Users\physicsuser\Downloads\dfV\find_circles\yGrid_18_04.npy')
z = []
res = []
...
fig, ax = plt.subplots()
cmap=DefineColourbar2(fig, ax, min(res), max(res), 100,  colourbarLabel = '$V_{contact}$')
